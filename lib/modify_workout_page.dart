                    ...
                    await showDialog(
                        ...
                        builder: (BuildContext context) {
                          return new SimpleDialog(
                            ...
                            elevation: 5.0,
                            title: AutoSizeText(
                              'You will loose all progress of this Workout!\n\nDo you really want to delete it?',
                              style: TextStyle(
                                fontSize: 20.0,
                              ),
                              maxLines: 4,
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  SimpleDialogOption(
                                    ...
                                    onPressed: () {Navigator.pop(context, AlertReturn.Yes);},
                                  ),
                                  VerticalDivider(),
                                  SimpleDialogOption(
                                    child: AutoSizeText(
                                    ...
                                    onPressed: () {Navigator.pop(context, AlertReturn.No);},
                                  ),
                                ],
                              ),
                            ],
